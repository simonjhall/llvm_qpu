...
StringRef MCSymbolRefExpr::getVariantKindName(VariantKind Kind) {
  ...
  case VK_Qpu_GPREL: return "GPREL";
...
//  case VK_Qpu_ABS_LO: return "ABS_LO";
  ...
  case VK_Qpu_DTPREL_LO: return "DTPREL_LO";
  case VK_Qpu_GOTTPREL: return "GOTTPREL";
  case VK_Qpu_TPREL_HI: return "TPREL_HI";
  case VK_Qpu_TPREL_LO: return "TPREL_LO";
  case VK_Qpu_GPOFF_HI: return "GPOFF_HI";
  case VK_Qpu_GPOFF_LO: return "GPOFF_LO";
  case VK_Qpu_GOT_DISP: return "GOT_DISP";
  case VK_Qpu_GOT_PAGE: return "GOT_PAGE";
  case VK_Qpu_GOT_OFST: return "GOT_OFST";
  case VK_Qpu_HIGHER:   return "HIGHER";
  case VK_Qpu_HIGHEST:  return "HIGHEST";
  case VK_Qpu_GOT_HI16: return "GOT_HI16";
  case VK_Qpu_GOT_LO16: return "GOT_LO16";
  case VK_Qpu_CALL_HI16: return "CALL_HI16";
  case VK_Qpu_CALL_LO16: return "CALL_LO16";
