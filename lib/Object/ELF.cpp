...
StringRef getELFRelocationTypeName(uint32_t Machine, uint32_t Type) {
  ...
  case ELF::EM_QPU:	// llvm-objdump -t -r
    switch (Type) {
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_NONE);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_24);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_32);
//      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_HI16);
//      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_HILO);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_GPREL16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_LITERAL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_GOT16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_PC16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_PC24);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_CALL16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_GOT_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_GOT_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_RELGOT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_TLS_TPREL32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_GLOB_DAT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_QPU_JUMP_SLOT);
    default: 
      break;
    }
    break;
